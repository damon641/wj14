...
module.exports = {
  ...
  get: async function(id){
    try {
      if(Sys.Rooms[id]){
        ...
        Sys.Rooms[room.id]  = new Sys.Game.Reguler.Omaha.Entities.Room().createObject(room); // Save room in Game object
  ...
  create: async function(data){
    ...
    try {
      ...
      if(room){
        Sys.Rooms[room.id] = new Sys.Game.Reguler.Omaha.Entities.Room().createObject(room);
